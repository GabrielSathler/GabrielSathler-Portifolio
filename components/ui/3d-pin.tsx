...
export const PinContainer = ({
    ...
    useEffect(() => {
        // Isso garante que as animações e os estados dinâmicos sejam aplicados apenas no cliente
        setIsClient(true);
    }, []);
    ...
    if (!isClient) return null; // Só renderiza no cliente

    return (
        <Link
            href={href || "/"} // Adiciona o redirecionamento com o Link
            className={cn(
